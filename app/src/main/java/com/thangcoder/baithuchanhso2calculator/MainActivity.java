...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initWidget() {
       ...
       // Glide.with(this).load(url).apply(RequestOptions.circleCropTransform()).into(imageView);
        Glide.with(this).load(R.mipmap.author).asBitmap().centerCrop().into(new BitmapImageViewTarget(imgAvatar) {
            @Override
